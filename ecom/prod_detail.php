<?php  include("header.php") ;
 ...
 ?>
  ...
  <div class="col-md-7 col-sm-9 col-xs-9 col-md-offset-2 main"  style="margin-top:px"> 
   ...
   <img src ='admin/product_images/$prod_image' style=\"height:380px; width:510px;\"> 

       <h4 style=\"margin-top:20px;padding:0px;text-align:center;\";>$prod_name <br>   price: €$prod_price</h4> 
